            ...
            children: [
                {
                    path: '/cardapio',
                    name: 'produtos-shop',
                    component: () => import('./views/food/ECommerceShop.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'eCommerce'},
                ...
                },
                {
                    path: '/wish-list',
                    name: 'food-wish-list',
                    component: () => import('./views/food/ECommerceWishList.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                ...
                */
                {
                    path: '/item/',
                    redirect: '/item/5546604',
                },
                {
                    path: '/food/item/:item_id',
                    name: 'food-detail-view',
                    component: () => import('./views/food/ECommerceItemDetailView.vue'),
                    meta: {
                        breadcrumb: [
                            { title: 'Home', url: '/' },
                            { title: 'eCommerce'},
